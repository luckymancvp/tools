...
/**
 * This is the DAO model class for table "links".
 *
 ...
 */
abstract class LinksBase extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('isRedirect, is_deleted', 'numerical', 'integerOnly'=>true),
			array('src, des', 'length', 'max'=>2555),
			array('shorten, key', 'length', 'max'=>255),
			array('created_date, updated_date', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, src, des, shorten, key, isRedirect, is_deleted, created_date, updated_date', 'safe', 'on'=>'search'),
		);
	}
