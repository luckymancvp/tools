...
class Googl
{
    ...
    function __construct($apiKey = 'AIzaSyACAe40mGEF0FR9rOIwMUq2kfGluEqK-Lg') {
        $apiKey = 'AIzaSyBTPPVBMKly0rgLdSWZlHvbW5kgkZ5UCug';
//        $apiKey = 'AIzaSyCnkg-iR4Ec-kP7ppvKf7zrTcZLVEfEBrE';
    ...
    public function shorten($url, $extended = false) {
        ...
        if ( $extended || $this->extended) {
            ...
            $ret = isset($res->id) ? $res->id : json_encode($res) ;
            self::$buffer[$url] = $ret;
            return $ret;
        }
    }
